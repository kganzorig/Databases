...
INSERT INTO recipes (name, cooking_time, rating) VALUES('Kimchi stew', '20', '5');
...
e.g psql -h 127.0.0.1 recipes_directory_test < spec/seeds_recipes.sql
```
...
recipes.length # => 2
recipes.first.id # => '1'
recipes.first.name # => 'Kimchi stew'
